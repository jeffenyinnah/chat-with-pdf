...
const features = [
  ...
  },
  {
    ...
    description:
      "Engage with your PDFs like never before using our intuitive and interative viewer.",
    icon: EyeIcon,
  },
  {
    name: "Cloud Backup",
    description:
      "Rest assured knowing your documents are safely up on the cloud, protected from or damage.",
    icon: ServerCogIcon,
  },
  {
...
export default function Home() {
  return (
    <main
      className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl 
    from-white to-indigo-600"
    >
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div
          className="flex flex-col justify-center items-center mx-auto max-w-7xl
        px-6 lg:px-8"
        >
          <div className="mx-auto max-w-3xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br /> Upload your document, and out chatbot will answer
              ...
              enchancing productivity 10x fold effortlessy.
            </p>
          </div>
